...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, IIC1_SCL_Pin|IIC1_SDA_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PAPin PA5 PA6 PA7 */
  GPIO_InitStruct.Pin = SW1_Pin|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : PBPin PBPin */
  GPIO_InitStruct.Pin = SPEED_IN1_Pin|SPEED_IN2_Pin;
