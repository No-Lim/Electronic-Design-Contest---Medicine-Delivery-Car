...
#define ESP8266_WIFI_INFO		"AT+CWJAP=\"QAQ\",\"wxl123456\"\r\n"
...
_Bool ESP8266_SendCmd(char *cmd, char *res)
{
    ...
    HAL_UART_Transmit(&huart6, (uint8_t *)cmd, strlen((const char *)cmd), 500);
...
void ESP8266_Init(void)
{
	...
	OLED_Clear(); OLED_ShowString(5,1,"ESP8266 Init OK"); HAL_Delay(500);
